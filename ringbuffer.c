...
//#define ALIGN_FLOOR(val, align) (val &= ~(align - 1)) /* 提供你的實作 */
//#define ALIGN_FLOOR(val, align) ((val + align-1) & ~(align - 1)) /* 提供你的實作 */
                                           ...
                                           const unsigned n)
{
    ...
    //if (prod_next - cons_tail > r->prod.watermark) return -EDQUOT;
    //XXX /* 請提交你的實作 */;
